...
# JPUSH
PUSH_NOTIFICATIONS_SETTINGS.setdefault("JPUSH_POST_URL", "https://api.jpush.cn/v3/push")
PUSH_NOTIFICATIONS_SETTINGS.setdefault("JPUSH_MAX_RECIPIENTS", 1000)
PUSH_NOTIFICATIONS_SETTINGS.setdefault("JPUSH_PLATFORM", ["android"])
