    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_id', models.UUIDField(blank=True, help_text='UDID / UIDevice.identifierForVendor()', null=True, verbose_name='Device ID', db_index=True)),
                ('registration_id', models.CharField(unique=True, max_length=200, verbose_name='Registration ID')),
